...
{
    public partial class AddUserFavoriteFilm : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteFilms", x => new { x.UserId, x.FilmId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserFavoriteFilms_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWatchlist", x => new { x.UserId, x.FilmId });
                    table.ForeignKey(
